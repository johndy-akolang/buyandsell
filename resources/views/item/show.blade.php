            ...
            <div class="cont span_2_of_3">
                ...
                <div class="grid images_3_of_2">
                    <ul id="etalage">
                        <li>
                            <a href="#">
								<img class="etalage_thumb_image" src="{{ asset($item->images) }}" class="img-responsive" />
                                <!-- <img class="etalage_source_image" src="{{ asset($item->images) }}" class="img-responsive" width="300" /> -->
								<!--
